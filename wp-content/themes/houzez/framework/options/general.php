...
Redux::setSection( $houzez_opt_name, array(
    ...
    'fields'        => array(
        /*array(
            'id'       => 'location_dependent',
            'type'     => 'switch',
            'title'    => esc_html__( 'Dependent Locations', 'houzez' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Enable dependent locations( country, state, city, area) for searches and add new property.', 'houzez' ),
            'default'  => 1,
